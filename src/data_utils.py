...
def get_output_layers(model):
    ...
    output_layers = [layers_name[i - 1] for i in model.getUnconnectedOutLayers()] # https://stackoverflow.com/questions/32978575/how-to-fix-indexerror-invalid-index-to-scalar-variable
